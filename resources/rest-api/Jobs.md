...
```sh
# curl -s -X POST --user "userOf3rdPartyTool:APITokenFrom3rdPartyTool" "URLOfJenkinsMachine/createItem?name=nameOfTheNewJob" --data-binary @config.xml -H "Jenkins-Crumb:crumbObtainPreviusly" -H "Content-Type:text/xml"
```
