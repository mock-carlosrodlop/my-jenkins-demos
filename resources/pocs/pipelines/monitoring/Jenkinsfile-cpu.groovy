   ...
   stages {
    ...
    post {
        success {
            ...
            mail body: "<b>CPU above 90%</b> <br>Reported by: ${env.JOB_NAME} <br>System time: ${timestamp} <br>Build Number: ${env.BUILD_NUMBER} <br>URL de build: ${env.BUILD_URL} <br>Data Package Success: CPU_Data-${timestamp}.zip",
